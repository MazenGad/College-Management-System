	...
	<div class="head">
		<div class="well ">
			<ul class="nav ">
				...
				<li style="margin-bottom:10px;" class="active"><a href="single-student.php"><i class="icon-group icon-2x"></i>Student Profile</a></li>
		...
		<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left; margin-top:50px;">
			<thead>
				<tr>
					...
					<th style=" background-color: #222023;"width="15%"> Full Name </th>
					...
					<th style=" background-color: #222023;" width="15%"> Academic Year </th>
				</tr>
			</thead>
			<tbody>
