...
<body>
  ...
  <div class="head">
    <div class="well">
      ...
      <li style="margin-bottom:10px; " class="active"><a href="addstudent.php"><i class="icon-user icon-2x"></i>Add Student</a> </li>
  ...
  <div class="span10">
    ...
    <div>
      ...
      <form action="savestudent.php" method="post" enctype="multipart/form-data">
        ...
        <center>
          <div id="ac">
            <span>Student Image:</span><input type="file" style="height: 50px;width: 266px;" name="file" id="file" required><br><br>
            <input type="hidden" name="memi" value="<?php echo $id; ?>" />
            <span>Student ID: </span><input type="text" style="width:265px; height:30px;" value="TD17-<?php
                                                                                                      $prefix = md5(time() * rand(1, 2));
                                                                                                      echo strip_tags(substr($prefix, 0, 4)); ?>" name="student_id" readonly Required /><br>
            <span>Password : </span><input type="text" style="width:265px; height:30px;" name="pass" Required /><br>
            ...
            <span>Academic Year: </span><input type="text" style="width:265px; height:30px;" name="Year" Required /><br>
            <span>Gender: </span>
