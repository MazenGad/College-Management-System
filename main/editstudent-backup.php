                    ...
                    <center><?php
                            ...
                            <form action="saveeditstudent.php" method="post" enctype="multipart/form-data">
                                ...
                                <div id="ac">
                                    ...
                                    <span>Acadamic Year:</span><input type="text" style="width:265px; height:30px;" name="Year" value="<?php echo $row['Year']; ?>" /><br>
                                    <span>one : </span><input type="text" style="width:265px; height:30px;" name="one" value="<?php echo $row['one']; ?>" /><br>
                                    <span>two : </span><input type="text" style="width:265px; height:30px;" name="two" value="<?php echo $row['two']; ?>" /><br>
                                    <span>three : </span><input type="text" style="width:265px; height:30px;" name="three" value="<?php echo $row['three']; ?>" /><br>
                                    <span>four : </span><input type="text" style="width:265px; height:30px;" name="four" value="<?php echo $row['four']; ?>" /><br>
                                    <span>five : </span><input type="text" style="width:265px; height:30px;" name="five" value="<?php echo $row['five']; ?>" /><br>
                                    <span>six : </span><input type="text" style="width:265px; height:30px;" name="six" value="<?php echo $row['six']; ?>" /><br>
