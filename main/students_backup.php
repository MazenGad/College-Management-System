                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <td><a title="Click to view the Student" href="viewstudent.php?id=<?php echo $row['id']; ?>"><button class="btn btn-success btn-mini"><i class="icon-search"></i> View</button> </a>
                                ...
                                <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete"><button style="margin-top:10px;" class="btn btn-danger btn-mini"><i class="icon-trash"></i> Delete</button></a>
                            </td>
                            </tr>
                        <?php
                        }
