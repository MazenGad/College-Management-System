...
<body>
	...
	?>
	<form class="login" action="login-student.php" method="POST">
		<fieldset>
			<legend class="legend">Student Login</legend>

			<div class="input">
			<input type="text" name="student_id" Placeholder="Student ID(ID Number)" required />
			...
			<button type="submit" name="submit1" href="dashboard.html" class="submit"><i class="fas fa-long-arrow-alt-right"></i></button>
		</fieldset>
	</form>
</body>
